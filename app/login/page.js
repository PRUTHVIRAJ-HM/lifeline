        ...
        <div className="relative z-10 text-center max-w-lg">
          ...
          <div className="grid grid-cols-3 gap-6 mt-12">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 font-medium">100+ Courses</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 font-medium">500+ Students</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 font-medium">Better Content</p>
            </div>
          </div>
        </div>
      </div>
